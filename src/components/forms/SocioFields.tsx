...
export function SocioFields({ value, onChange, errors }: Props) {
  const set = <K extends keyof SocioData>(k: K, v: SocioData[K]) => onChange({ ...value, [k]: v });
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      {field(
        "rg",
        "RG",
        <Input id="rg" value={value.rg} onChange={(e) => set("rg", maskRG(e.target.value))} />,
        errors?.rg,
      )}
      ...
      {field(
        "bairro",
        "Bairro",
        <Input id="bairro" value={value.bairro} onChange={(e) => set("bairro", e.target.value)} />,
        errors?.bairro,
      )}
      ...
      {field(
        "cidade",
        "Cidade",
        <Input id="cidade" value={value.cidade} onChange={(e) => set("cidade", e.target.value)} />,
        errors?.cidade,
      )}
