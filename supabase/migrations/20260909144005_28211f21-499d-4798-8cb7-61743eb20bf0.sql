...
GRANT ALL ON public.marketing_calendario TO service_role;
...
CREATE TRIGGER set_marketing_calendario_updated_at
  BEFORE UPDATE ON public.marketing_calendario
