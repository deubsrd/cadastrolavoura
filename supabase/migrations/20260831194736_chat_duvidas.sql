-- ============================================================
-- Chat de tira-dúvidas do franqueado: fila de pendências +
-- base de conhecimento que a IA aprende com o tempo
-- ============================================================

-- Perguntas que a IA não conseguiu responder com o manual/base atual.
-- Só a edge function (service role) grava aqui; admin lê/edita via painel.
...
-- Perguntas e respostas já ensinadas ao assistente (pelo admin, ao responder
-- uma dúvida pendente, ou cadastradas direto). Some ao contexto do chat.
