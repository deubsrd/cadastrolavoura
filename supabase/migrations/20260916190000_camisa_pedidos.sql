-- Pedidos de camisa da Lavoura: o franqueado informa tamanho + quantidade,
-- a franqueadora vê tudo consolidado (por tamanho e por unidade) pra fechar
...
-- Franqueado: vê e cria só os próprios pedidos
...
-- Franqueadora (admin): vê tudo, pode marcar como atendido
