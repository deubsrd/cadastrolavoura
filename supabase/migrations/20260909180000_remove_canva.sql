-- Remoção da integração com o Canva Connect API — decisão de simplificar o
-- gerador de posts em vez de manter a dependência de OAuth externo, que
-- vinha causando falhas difíceis de diagnosticar.
